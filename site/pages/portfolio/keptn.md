---
title: "keptn — Cloud-Native Lifecycle Orchestration"
alias: ""
tags: []
weight: 1
...
![keptn logo](../assets/portfolio/keptn-logo.png)
...
The project was incubated by the **Cloud Native Computing Foundation (CNCF)** and reached end-of-life on December 22, 2023, succeeded by the [Keptn Lifecycle Toolkit](https://github.com/keptn/lifecycle-toolkit).
...
I contributed to several repos in the [keptn-sandbox](https://github.com/keptn-sandbox) organization, which hosts experimental integrations and tooling for the keptn ecosystem:

- [**keptn-sandbox/keptn-service-template-go**](https://github.com/keptn-sandbox/keptn-service-template-go) — **Maintained** the canonical Go template for building keptn services; used by the community as the starting point for all new keptn integrations
- [**keptn-sandbox/action-install-keptn**](https://github.com/keptn-sandbox/action-install-keptn) — GitHub Action for installing keptn in CI pipelines
- [**keptn-sandbox/keptn-jenkins-library**](https://github.com/keptn-sandbox/keptn-jenkins-library) — Jenkins shared library for keptn use cases

## keptn-contrib Contributions

The [keptn-contrib](https://github.com/keptn-contrib) organization hosts stable, graduated integrations for the keptn ecosystem. My main contribution here was the [**dynatrace-service**](https://github.com/keptn-contrib/dynatrace-service) — the official keptn integration with Dynatrace, enabling SLO-based quality gates and automated remediation driven by Dynatrace monitoring data.
...
- **Registries**: GitHub Container Registry (`ghcr.io/keptn`), Quay.io
- **Integrations**: Jenkins, GitHub, GitLab, Harness, ArgoCD, Flux
...
- [GitHub — keptn/keptn](https://github.com/keptn/keptn)
- [keptn.sh](https://keptn.sh)
- [@christian-kreuzberger-dtx on GitHub](https://github.com/christian-kreuzberger-dtx)
- [keptn-sandbox org](https://github.com/keptn-sandbox)
- [keptn-contrib org](https://github.com/keptn-contrib)
