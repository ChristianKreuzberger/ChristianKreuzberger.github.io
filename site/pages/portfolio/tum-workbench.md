...
- [**djangodav**](https://github.com/anx-ckreuzberger/djangodav) — WebDAV extension for Django, including an [example app](https://github.com/anx-ckreuzberger/djangodav-example-app)
- [**gunicorn-nginx-socket-docker**](https://github.com/anx-ckreuzberger/gunicorn-nginx-socket-docker) — Docker deployment pattern for gunicorn + nginx via Unix socket (5 stars)
